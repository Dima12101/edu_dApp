...
function handleAccountsChanged(accounts) {
    ...
    if (accounts.length === 0) {
        ...
        // $('#status').html('<p style="color:green">Success connection!</p>')
    ...
    $('.btn-mint').click(function() {
        ...
        $.post("mint/"+name, function(data){
            ...
            function(data){
                ...
                .then((txHash) => {
                    console.log(txHash);
                    $('#status').append('<p style="color:green">Success mint "' + name + '". TxHash: ' + txHash + '</p>');
                })
                .catch((error) => console.error);
            }
        ).fail(function(data){
            console.log(data);
            $('#status').append('<p style="color:red">Error mint "' + name + '". ' + data['responseText'] + '</p>');
        });
    });
})
